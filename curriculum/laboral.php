	...
	<div id="contenido">
	    ...
	    <div class="div12"></div>
	   	...
	   	<form onsubmit="return false">
	   		...
	   		<div class="div4"><input style="width: 200px;" style="width: 190px;" type="date" id="fecini"></div>
	   		<div class="div4"><input style="width: 200px;" style="width: 190px;"  type="date" id="fecfin"></div>
	   		<div class="div12"></div>

	   		<div class="div4"></div><div class="div4"> <h4>Cronología</h4></div><div class="div4"></div>
	   		<div class="div12"></div>
	   		<div class="div4"></div><div class="div4"> <input style="width: 200px;" placeholder="ej. Actual" type="text" id="crono"></div><div class="div4"></div>
