	...
	<div id="contenido">
	    ...
	    <div class="div12"></div>
	   	...
	   	<form onsubmit="return false">
	   		...
	   		<div class="div3"><input type="text" id="titulo" value=<?php echo $row[5] ?>>
	   		</div>
	   		...
	   		<div class="div3"><input type="date" id="fecini" value=<?php echo $row[6] ?>></div>
	   		
	   		<div class="div12"></div>
	   		<div class="div2"><h4>Fecha de termino</h4></div>
	   		<div class="div3"><input type="date" id="fecter" value=<?php echo $row[7]; ?>></div>	   		
	   		<div class="div1"></div><div class="div2"><h4>No. alumnos</h4></div>
	   		<div class="div3"><input type="text" id="alumno" value=<?php echo $row[8] ?>></div>
	   		...
	   		<div class="div3"><select id="state" onblur="validar2(this.id)"><?php $qri = "SELECT Estado AS nombre, idEstado AS clave FROM estadoactual";
						...
						<option value="<?php echo $row1->clave;?>" <?php if ($row1->nombre==$row[10]) {
							echo "selected";
						} ?>> <?php echo ($row1->nombre);?> </option>
					<?php } ?>
				</select></div>
